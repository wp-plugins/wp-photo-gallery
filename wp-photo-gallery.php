     ...
     <div style="width: 100%;">  
        <div style="float:left;width:69%;">
            <div class="wrap">
              ...
              ?>      
               <span><h3 style="color: blue;"><a target="_blank" href="http://www.my-php-scripts.net/index.php/Wordpress/wordpress-photo-gallery-pro.html">Update to WordPres Photo Gallery Pro Version</a></h3></span>
               <br/>
                                      ...
                                      <td class="value">
                                        <table>
                                          <tr>
                                             ...
                                             <td>
                                              <input type="button" name="cancle" id="cancle" value="Cancel" class="button-primary" onclick="location.href='admin.php?page=photo_gallery_image_management'">
                                             </td>
                                          </tr>
                                        </table>
                                    </td>
  ...
  <?php 
   ...
   ?> 
     <div class="wrap">
       ...
       <div style="width: 100%;">  
        <div style="float:left;width:69%;" >
        <span><h3 style="color: blue;"><a target="_blank" href="http://www.my-php-scripts.net/index.php/Wordpress/wordpress-photo-gallery-pro.html">Update to WordPress Photo Gallery Pro Version</a></h3></span>
